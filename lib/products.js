...
export const products = [
  { id: 'conflict-duality-tee', name: 'Conflict & Duality Tee', price: 2999, salePrice: null, category: 'Tops', collection: 'New Arrivals', color: 'White', sizes: ['S','M','L'], featured: true,
    image: "url('/products/tee-main.jpg') center/cover no-repeat", image2: "url('/products/tee-angle.jpg') center/cover no-repeat",
    images: ["url('/products/tee-main.jpg') center/cover no-repeat", "url('/products/tee-angle.jpg') center/cover no-repeat", "url('/products/tee-detail.jpg') center/cover no-repeat"],
  ...
  { id: 'krta-panther-cap', name: 'KRTA Phantom Cap', price: 1999, salePrice: null, category: 'Cap', collection: 'Caps', color: 'Black', sizes: ['One Size'], featured: true,
    image: "url('/products/cap-main.jpg') center/cover no-repeat", image2: "url('/products/cap-detail.jpg') center/cover no-repeat",
    images: ["url('/products/cap-main.jpg') center/cover no-repeat", "url('/products/cap-detail.jpg') center/cover no-repeat", "url('/products/cap-side.jpg') center/cover no-repeat"],
  ...
  { id: 'p1', name: 'Brushed Ink Tee', price: 4800, salePrice: null, category: 'Tops', collection: 'New Arrivals', color: 'Charcoal', sizes: ['XS','S','M','L'], featured: true,
    image: 'linear-gradient(150deg,#e7e2da 0%,#cfc7ba 100%)', image2: 'linear-gradient(150deg,#1b1b1b 0%,#3a3a3a 100%)' },
  { id: 'p2', name: 'Acid Wash Wide Trouser', price: 9200, salePrice: 7800, category: 'Bottoms', collection: 'Limited Edition', color: 'Ochre', sizes: ['S','M','L'], featured: true,
  ...
  { id: 'p4', name: 'Pigment Study Hoodie', price: 8800, salePrice: null, category: 'Tops', collection: 'New Arrivals', color: 'Slate', sizes: ['S','M','L'], featured: true,
    image: 'linear-gradient(150deg,#b9c6e8 0%,#6f86c9 100%)', image2: 'linear-gradient(150deg,#1a3fd6 0%,#13287f 100%)' },
  { id: 'p5', name: 'Canvas Cargo', price: 10500, salePrice: null, category: 'Bottoms', collection: 'Best Sellers', color: 'Clay', sizes: ['S','M','L'], featured: false,
    image: 'linear-gradient(150deg,#e3d6c4 0%,#b59b78 100%)', image2: 'linear-gradient(150deg,#7a6446 0%,#473a28 100%)' },
  { id: 'p6', name: 'Stroke Knit', price: 7200, salePrice: null, category: 'Tops', collection: 'Best Sellers', color: 'Bone', sizes: ['S','M','L'], featured: false,
    image: 'linear-gradient(150deg,#f3efe7 0%,#ddd6c8 100%)', image2: 'linear-gradient(150deg,#cfc4ae 0%,#9b8f73 100%)' },
  { id: 'p7', name: 'Raw Edge Denim Jacket', price: 12500, salePrice: null, category: 'Outerwear', collection: 'Limited Edition', color: 'Indigo', sizes: ['S','M','L'], featured: false,
