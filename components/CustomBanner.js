...
function VideoPanel({ clip }) {
  ...
  // Only decode/play while the panel is actually on screen — this alone is enough;
  // pausing/resuming on every scroll event (an earlier attempt) made playback visibly
  // freeze and restart, which was worse than the scroll jank it was meant to fix.
  useEffect(() => {
