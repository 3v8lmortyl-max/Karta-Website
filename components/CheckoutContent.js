        ...
        <div className="checkout-form-col">
          <section className="checkout-section">
            ...
            <label className="admin-field">
              <span>Email</span>
              <input className="admin-input" type="email" value={shipping.email}
            ...
            {useNewAddress && (
              <div className="checkout-address-fields">
                <label className="admin-field"><span>Full name</span>
                  <input className="admin-input" value={shipping.full_name} onChange={(e) => setShipping({ ...shipping, full_name: e.target.value })} required />
                </label>
                <label className="admin-field"><span>Phone</span>
                  <input className="admin-input" value={shipping.phone} onChange={(e) => setShipping({ ...shipping, phone: e.target.value })} required />
                </label>
                <label className="admin-field"><span>Address line 1</span>
                  <input className="admin-input" value={shipping.line1} onChange={(e) => setShipping({ ...shipping, line1: e.target.value })} required />
                </label>
                <label className="admin-field"><span>Address line 2 (optional)</span>
                  <input className="admin-input" value={shipping.line2} onChange={(e) => setShipping({ ...shipping, line2: e.target.value })} />
                </label>
                <div className="admin-field-row">
                  <label className="admin-field"><span>City</span>
                    <input className="admin-input" value={shipping.city} onChange={(e) => setShipping({ ...shipping, city: e.target.value })} required />
                  </label>
                  <label className="admin-field"><span>State</span>
                    <input className="admin-input" value={shipping.state} onChange={(e) => setShipping({ ...shipping, state: e.target.value })} required />
                  </label>
                  <label className="admin-field"><span>Pincode</span>
                    <input className="admin-input" value={shipping.pincode} onChange={(e) => setShipping({ ...shipping, pincode: e.target.value })} required />
                  </label>
                </div>
                {signedIn && (
          ...
          <button className="btn-solid checkout-pay-btn" disabled={placing}>
            {placing ? 'Processing…' : `Pay ${formatINR(subtotal)}`}
          </button>
